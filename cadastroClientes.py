...
def exportar_clientes():
    ...
    clientes_cadastrados = pa.DataFrame(clientes_cadastrados, columns=('nome', 'sobrenome', 'email','telefone', 'id_banco'))
...
botao_exportar = tk.Button(janela, text='exportar Cliente', command='exportar_clientes')
